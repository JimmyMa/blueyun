...
define('models/gallery/ImageModel',[
  'underscore',
  'backbone',
], function(_, Backbone) {
...
define('collections/gallery/ImageCollection',[
  'underscore',
  'backbone',
...
define('models/gallery/CategoryModel',[
  'underscore',
  'backbone',
], function(_, Backbone) {
...
define('collections/gallery/CategoryCollection',[
  'underscore',
  'backbone',
...
define('text!templates/home/homeTemplate.html',[],function () { return '  <div id="homeSlide">\r\n    Loading....\r\n  </div>\r\n  <div id="homeMain">\r\n\r\n  </div>\r\n';});
...
define('models/owner/OwnerModel',[
  'underscore',
  'backbone',
], function(_, Backbone) {
...
define('text!templates/footer/footerTemplate.html',[],function () { return '<p>&copy; 2012</p>';});

define('views/footer/FooterView',[
  'jquery',
  'underscore',
  'backbone',
...
define('views/gallery/ImageSliderView',[
  'jquery',
  'underscore',
  'backbone',
  'collections/gallery/ImageCollection',
...
define('views/users/UserLoginView',[
  'jquery',
  'underscore',
  'backbone',
...
define('collections/blog/PostCollection',[
  'underscore',
  'backbone',
...
define('text!templates/blog/postsListTemplate.html',[],function () { return '<%\r\n_.each( posts, function(post) { \r\nvar postHref = "#/blog/post/" + post.id;\r\n%>\r\n<div class="row">\r\n      <div class="span12">\r\n        <h4><strong><a href="<%=postHref%>"><%=post.title%></a></strong></h4>\r\n      </div>\r\n</div>\r\n<div class="row">\r\n      <%if ( post.thumbnail != null ) {%>\r\n      <div class="span2">\r\n        <a href="<%=postHref%>" class="thumbnail">\r\n            <img src="<%=post.thumbnail%>" alt="">\r\n        </a>\r\n      </div>\r\n      <div class="span10">\r\n      <%} else {%>\r\n      <div class="span12">\r\n      <%}%>      \r\n        <p>\r\n          <%=post.content%>\r\n        </p>\r\n        <p><a class="btn" href="<%=postHref%>">Read more</a></p>\r\n      </div>\r\n</div>\r\n    <div class="row">\r\n      <div class="span12">\r\n        <p></p>\r\n        <p>\r\n          <!--i class="icon-user"></i> by <a href="#">John</a--> \r\n          <!--|--> <i class="icon-calendar"></i> <%=post.create_date%>\r\n          <!--| <i class="icon-comment"></i> <a href="#">3 Comments</a-->\r\n          <!--| <i class="icon-share"></i> <a href="#">39 Shares</a-->\r\n          | <i class="icon-tags"></i> Tags : \r\n          <%\r\n\t\t\t_.each( post.tagsList, function(tag) { \r\n          %>\r\n          <a href="#"><span class="label label-info"><%=tag%></span></a> \r\n          <%});%>\r\n        </p>\r\n      </div>\r\n    </div>\r\n<hr>\r\n<%});%>';});

define('views/blog/PostsListView',[
  'jquery',
  'underscore',
  'backbone',
...
define('text!templates/blog/postTemplate.html',[],function () { return '<link rel="stylesheet" href="/assets/kindeditor/plugins/code/sons-of-obsidian.css">\r\n<div class="row">\r\n      <div class="span12">\r\n        <h4><strong><%=post.title%></strong></h4>\r\n      </div>\r\n</div>\r\n<div class="row">\r\n      <div class="span12">\r\n        <p></p>\r\n        <p>\r\n          <!--i class="icon-user"></i> by <a href="#">John</a--> \r\n          <!--|--> <i class="icon-calendar"></i> <%=post.create_date%>\r\n          <!--| <i class="icon-comment"></i> <a href="#">3 Comments</a-->\r\n          <!--| <i class="icon-share"></i> <a href="#">39 Shares</a-->\r\n          | <i class="icon-tags"></i> Tags : \r\n          <%\r\n\t\t\t_.each( post.tagsList, function(tag) { \r\n          %>\r\n          <a href="#"><span class="label label-info"><%=tag%></span></a> \r\n          <%});%>\r\n        </p>\r\n      </div>\r\n</div>\r\n<div class="row">\r\n      <div class="span12">\r\n          <%=post.content%>\r\n      </div>\r\n</div>\r\n';});
